...
typedef struct {
    /* Strong reference to cached long to avoid malloc. */
    PyLongObject *cached_long;
} _PyForIterCache;
...
int _Py_Specialize_ForIter(_Py_CODEUNIT *instr, PyObject *iter,
